...
public class ColorsActivity extends BaseActivity {
    ...
    private WordAdapter wordAdapter = new WordAdapter(this, R.color.category_colors);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager colorsListLayoutManager = new LinearLayoutManager(this, LinearLayoutManager.VERTICAL, false);
        RecyclerView listView = findViewById(R.id.word_list);
        listView.setLayoutManager(colorsListLayoutManager);
